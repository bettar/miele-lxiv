...
my @fromdirs = ("$ENV{PROJECT_DIR}/cocoahttpserver", "$ENV{PROJECT_DIR}/OsiriXClasses/2D", "$ENV{PROJECT_DIR}/OsiriXClasses/DICOMFiles", "$ENV{PROJECT_DIR}/OsiriXClasses/GUI", "$ENV{PROJECT_DIR}/OsiriXClasses/OSI", "$ENV{PROJECT_DIR}/OpenGL", "$ENV{PROJECT_DIR}/OsiriXClasses/ROI", "$ENV{PROJECT_DIR}/Nitrogen/Sources", "$ENV{PROJECT_DIR}/Nitrogen/Sources/JSON", $ENV{PROJECT_DIR});
